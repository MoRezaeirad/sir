...
15. No new external Go module dependencies without explicit review and CLAUDE.md amendment. The zero-external-dep invariant is enforced by CI but must also be a conscious decision.
