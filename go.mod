...
// present (GOTOOLCHAIN=auto is the default since Go 1.21). 1.25.11
// ships fixes for GO-2026-5037 (crypto/x509) and GO-2026-5039
// (net/textproto), on top of GO-2026-4971 (net Dial/LookupPort NUL byte
// panic on Windows), GO-2026-4918 (HTTP/2 infinite loop on bad
// SETTINGS_MAX_FRAME_SIZE), and the crypto/x509 + crypto/tls CVEs
// (GO-2026-4947, GO-2026-4946, GO-2026-4870) carried since 1.25.9. Do not
// downgrade without replacing the pin with an equally-patched version.
toolchain go1.25.11
